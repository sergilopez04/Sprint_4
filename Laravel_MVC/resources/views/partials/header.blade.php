...
<nav class="bg-green-800 p-4">
    <div class="container mx-auto flex justify-around">
        <a href="#" class="text-white font-bold hover:text-green-300">Show Teams</a>
        <a href="{{ route('teams.index') }}" class="text-white font-bold hover:text-green-300">Create Team</a>
        <a href="{{ route('matches.index') }}" class="text-white font-bold hover:text-green-300">Create Matches</a>
        <a href="#" class="text-white font-bold hover:text-green-300">Show Matches</a>
    </div>
</nav>
